...
class RentNegotiation extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RentNegotiation> createState() => _RentNegotiationState();
}

class _RentNegotiationState extends ConsumerState<RentNegotiation> {
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(formatCurrency(widget.currentPrice), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 18)),
                    ],
                  ),
                  Container(
                    ...
                    child: Text('Negotiable', style: TextStyle(color: AppColors.secondary, fontWeight: FontWeight.w600, fontSize: 12)),
                  ),
                ],
              ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Offer Submitted', style: TextStyle(color: AppColors.info, fontWeight: FontWeight.w600)),
                            Text('${formatCurrency(double.tryParse(_offerController.text.trim()) ?? 0)} - Awaiting landlord response', style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                          ],
                        ),
                      ),
                    ],
