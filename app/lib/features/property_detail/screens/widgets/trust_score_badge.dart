...
class TrustScoreBadgeWidget extends StatelessWidget {
  final double score;
  final double size;

  const TrustScoreBadgeWidget({
    super.key,
    required this.score,
    this.size = 80,
  });
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(_getScoreLabel(normalizedScore),
                    style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: color)),
                const SizedBox(height: 4),
                Text(_getScoreDescription(normalizedScore),
